...
async function generateQuestions(
  ...
  try {
    ...
    const prompt = `Generate ${numberOfQuestions} questions related to the subject "${subject}", under the topic "${topic}" with optionals details like ${optionalDetails}. Remove markdown tags like "*" `;
